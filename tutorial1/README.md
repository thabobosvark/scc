...
You will then login into the CHPC's Cloud Computing Platform and launch your own IBM Cloud virtual machine instances. Here you will need to make a decision on choice of Linux distribution that you will use as well as how your team will allocate your limited cloud computing resources.
...
- For example: Running a **Linux-based OS** while in a **Windows environment** using IBM Cloud's infrastructure
- The physical servers hosting your VMs are located in IBM's global data centers
...
If you've managed to successfully build and deploy your VM instance, and you managed to successfully associate and attach a floating IP, you are finally ready to connect to your newly created instance.
...
You have successfully completed you first HPL benchmark on IBM Cloud.
